(function () {
    ...
    function Ra(a, b) {
        ...
        if (1 < c) {
            ...
            if (a instanceof Ra)c = a.ka(), d = a.M(); else {
                var c = Ma(a), e = [], f = 0;
                for (d in a)e[f++] = a[d];
                d = e
            }
    ...
    g.M = function () {
        Sa(this);
        for (var a = [], b = 0; b < this.d.length; b++)a.push(this.F[this.d[b]]);
        return a
    };
    g.ka = function () {
        Sa(this);
    ...
    function Sa(a) {
        ...
        if (a.h != a.d.length) {
            for (var e = {}, c = b = 0; b < a.d.length;)d = a.d[b], Ta(e, d) || (a.d[c++] = d, e[d] = 1), b++;
            a.d.length = c
        }
    }
    ...
    var Za = function () {
        var a = "", b;
        if (Xa && h.opera)return a = h.opera.version, s(a) ? a() : a;
        ...
        if (!(b = $a[a])) {
            ...
            for (var c = String(Za).replace(/^[\s\xa0]+|[\s\xa0]+$/g, "").split("."), d = String(a).replace(/^[\s\xa0]+|[\s\xa0]+$/g, "").split("."), e = Math.max(c.length, d.length), f = 0; 0 == b && f < e; f++) {
                ...
                do {
                    ...
                    if (0 == N[0].length && 0 == J[0].length)break;
    ...
    function db(a) {
        if (eb) {
            ...
            if (b) {
                var c = b.href;
                if (c && (c = (c = db(c)[3] || null) && decodeURIComponent(c)) && c != b.hostname)throw eb = !0, Error();
            }
        }
        return a.match(cb)
    }
    ...
    function D(a, b) {
        var c;
        if (a instanceof D)this.q = n(b) ? b : a.q, fb(this, a.ga), c = a.Na, E(this), this.Na = c, c = a.P, E(this), this.P = c, gb(this, a.Ja), c = a.da, E(this), this.da = c, hb(this, a.G.I()), c = a.K, E(this), this.K = c; else if (a && (c = db(String(a)))) {
            this.q = !!b;
            fb(this, c[1] || "", !0);
            var d = c[2] || "";
            E(this);
            ...
            E(this);
            this.K = ib(c)
        } else this.q = !!b, this.G = new F(null, 0, this.q)
    }
    ...
    g.toString = function () {
        ...
        if (b = this.da)this.P && "/" != b.charAt(0) && a.push("/"), a.push(jb(b, "/" == b.charAt(0) ? lb : mb));
    ...
    function E(a) {
        if (a.lc)throw Error("Tried to modify a read-only Uri");
    }
    ...
    function G(a) {
        if (!a.c && (a.c = new Ra, a.h = 0, a.o))for (var b = a.o.split("&"), c = 0; c < b.length; c++) {
    ...
    g.ka = function () {
        G(this);
        for (var a = this.c.M(), b = this.c.ka(), c = [], d = 0; d < b.length; d++)for (var e = a[d], f = 0; f < e.length; f++)c.push(b[d]);
        return c
    };
    g.M = function (a) {
        G(this);
        var b = [];
        if (r(a))this.J(a) && (b = Ga(b, this.c.get(H(this, a)))); else {
            a = this.c.M();
    ...
    g.toString = function () {
        ...
        if (!this.c)return "";
        for (var a = [], b = this.c.ka(), c = 0; c < b.length; c++)for (var d = b[c], e = encodeURIComponent(String(d)), d = this.M(d), f = 0; f < d.length; f++) {
            var k = e;
    ...
    var I = {
        set: function (a, b) {
            ...
            for (var d =
                I.get(a), e = !1, f = 0; f < d.length; f++)d[f] == b && (Ia(d, f--, 1), e = !0);
    ...
    function wb(a, b, c) {
        ...
        if (b) {
            d = {};
            for (f = e = 0; k = c[f]; f++)a = k.className, "function" == typeof a.split && Ea(a.split(/\s+/), b) && (d[e++] = k);
            d.length = e;
            return d
        }
        return c
    ...
    O.prototype.e = function () {
        if (this.Ib)for (; this.Ib.length;)this.Ib.shift()()
    };
    function Pb(a) {
    ...
    Q.prototype.preventDefault = function () {
        ...
        var a = this.ia;
        if (a.preventDefault)a.preventDefault(); else if (a.returnValue = !1, Lb)try {
    ...
    g.O = function (a) {
        ...
        for (c in this.f)if (!a || c == a) {
            for (var d = this.f[c], e = 0; e < d.length; e++)++b, Ub(d[e]);
            delete this.f[c];
            this.ra--
        }
        return b
    ...
    g.ma = function (a, b) {
        ...
        return La(this.f, function (a) {
            for (var k = 0; k < a.length; ++k)if (!(c && a[k].type != d || e && a[k].V != b))return !0;
            return !1
        })
    };
    function Wb(a, b, c, d) {
        for (var e = 0; e < a.length; ++e) {
            var f = a[e];
            if (!f.fa && f.T == b && f.V == !!c && f.Aa == d)return e
        }
        return -1
    };
    M.Nc = {};
    ...
    M.b = function (a, b, c, d, e) {
        if (q(b)) {
            for (var f = 0; f < b.length; f++)M.b(a, b[f], c, d, e);
            return null
        }
        c = M.Oa(c);
    ...
    M.Ca = function (a, b, c, d, e, f) {
        ...
        var k = !!e;
        if (k && !Kb) {
            if (0 == M.Pa)return Aa("Can not register capture listener in IE8-."), null;
            if (1 == M.Pa)return null
        }
        var l = M.L(a);
        l || (a[M.Ra] = l = new Vb(a));
        c = l.add(b, c, d, e, f);
    ...
    M.ca = function (a, b, c, d, e) {
        if (q(b)) {
            for (var f = 0; f < b.length; f++)M.ca(a, b[f], c, d, e);
            return null
        }
        c = M.Oa(c);
    ...
    M.s = function (a, b, c, d, e) {
        if (q(b)) {
            for (var f = 0; f < b.length; f++)M.s(a, b[f], c, d, e);
            return null
        }
        c = M.Oa(c);
        if (R(a))return a.s(b, c, d, e);
        if (!a)return !1;
        if (a = M.L(a))if (b = a.R(b, c, !!d, e))return M.H(b);
        return !1
    };
    M.H = function (a) {
        if ("number" == typeof a || !a || a.fa)return !1;
        var b = a.src;
        if (R(b))return b.H(a);
        var c = a.type, d = a.Ka;
    ...
    M.O = function (a, b) {
        if (!a)return 0;
        if (R(a))return a.p ? a.p.O(b) : 0;
        var c = M.L(a);
        if (!c)return 0;
        var d = 0, e = b && b.toString(), f;
        for (f in c.f)if (!e || f == e)for (var k = Ha(c.f[f]), l = 0; l < k.length; ++l)M.H(k[l]) && ++d;
        return d
    };
    M.Qc = function () {
        return M.Da = 0
    ...
    M.Xa = function (a, b, c, d) {
        var e = 1;
        if (a = M.L(a))if (b = a.f[b.toString()])for (b = Ha(b), a = 0; a < b.length; a++) {
            var f = b[a];
    ...
    M.Za = function (a, b) {
        ...
        if (!Kb) {
            ...
            if (!(c = b))a:{
                c = ["window", "event"];
                for (var d = h, e; e = c.shift();)if (null != d[e])d = d[e]; else {
                    c = null;
                    break a
                }
                c = d
            ...
            if (2 == M.Pa) {
                if (!M.kc(e)) {
                    M.nc(e);
                    e = [];
                    for (var f = c.currentTarget; f; f = f.parentNode)e.push(f);
                    for (var f = a.type, k = e.length - 1; !c.U && 0 <= k; k--)c.currentTarget = e[k], d &= M.Xa(e[k], f, !0, c);
                    for (k = 0; !c.U && k < e.length; k++)c.currentTarget = e[k], d &= M.Xa(e[k], f, !1, c)
                }
            } else d = M.Wa(a, c);
            return d
        }
    ...
    function Zb(a, b, c, d, e, f) {
        if (q(c))for (var k = 0; k < c.length; k++)Zb(a, b, c[k], d, e, f); else {
    ...
    g.s = function (a, b, c, d, e) {
        if (q(b))for (var f = 0; f < b.length; f++)this.s(a, b[f], c, d, e); else if (a = M.R(a, b, c || this.handleEvent, d, e || this.N || this))M.H(a), delete this.d[a.key];
        return this
    };
    ...
    g.dispatchEvent = function (a) {
        ...
        if (r(a))a = new P(a, c); else if (a instanceof P)a.target = a.target || c; else {
            var e = a;
            a = new P(d, c);
            Qa(a, e)
        }
        var e = !0, f;
        if (b)for (var k = b.length - 1; !a.U && 0 <= k; k--)f = a.currentTarget = b[k], e = f.Z(d, !0, a) && e;
        a.U || (f = a.currentTarget = c, e = f.Z(d, !0, a) && e, a.U || (e = f.Z(d, !1, a) && e));
        if (b)for (k = 0; !a.U && k < b.length; k++)f = a.currentTarget = b[k], e = f.Z(d, !1, a) && e;
        return e
    };
    g.e = function () {
        U.g.e.call(this);
    ...
    g.start = function (a) {
        ...
        var b = this.Xb;
        a = n(a) ? a : this.jc;
        if (!s(b))if (b && "function" == typeof b.handleEvent)b = t(b.handleEvent, b); else throw Error("Invalid listener argument");
    ...
    g.r = 0;
    g.play = function (a) {
        if (a || this.i == ac)this.r = 0, this.coords = this.pa; else if (1 == this.i)return !1;
        dc(this);
        this.startTime = a = ja();
    ...
    function ic(a, b) {
        ...
        for (var c = 0; c < a.pa.length; c++)a.coords[c] = (a.dc[c] - a.pa[c]) * b + a.pa[c]
    }
    ...
    function qc(a) {
        ...
        for (a = a.parentNode; a && a != b; a = a.parentNode)if (c = nc(a), d = d && "static" == c && a != b.documentElement && a != b.body, !d && (a.scrollWidth > a.clientWidth || a.scrollHeight > a.clientHeight || "fixed" == c || "absolute" == c || "relative" == c))return a;
        return null
    };
    function rc() {
    }
    ...
    V.prototype.ib = function (a, b) {
        ...
        if (c) {
            ...
            this.La--;
            if (this.oa && 0 == this.La)for (; c = this.oa.pop();)if (0 != this.La)this.oa || (this.oa = []), this.oa.push(c); else if (d = this.A[c])(d = this.qa[d]) && Fa(d, c), delete this.A[c], delete this.A[c + 1], delete this.A[c + 2]
        }
    };
    ...
    g.sc = function (a) {
        if (13 == a.keyCode || 32 == a.keyCode)this.toggle(), this.dispatchEvent(new P("action", this)), a.preventDefault(), a.stopPropagation()
    };
    g.rc = function () {
        this.toggle();
    ...
    Ic.prototype.fc = function (a) {
        ...
        if (b != l)if (b.getBoundingClientRect) {
            b:{
                var p;
                try {
            ...
            k.x = c.left + p.x;
            k.y = c.top + p.y
        } else if (d.getBoxObjectFor && !f)c = d.getBoxObjectFor(b), p = d.getBoxObjectFor(l), k.x = c.screenX - p.screenX, k.y = c.screenY - p.screenY; else {
            c = b;
            do {
                k.x += c.offsetLeft;
                k.y += c.offsetTop;
            ...
            if (Xa || B && "absolute" == e)k.y -= d.body.offsetTop;
            for (c = b; (c = qc(c)) && c != d.body && c != l;)k.x -= c.scrollLeft, Xa && "TR" == c.tagName || (k.y -= c.scrollTop)
        }
    ...
    u("qp.ui.Futurizr", function (a, b) {
        var c = Y.k(), d;
        for (d in b)b.hasOwnProperty(d) && s(c[d]) && I.enable(a, b[d], c[d]())
    });
    function Z(a, b) {
        this.t = {};
    ...
    function bd() {
        Ic.call(this);
        var a;
        if (a = wb("a", "gweb-smoothscroll-control", null))for (var b = 0, c; c = a[b]; b++) {
            var d;
            d = pb(c.href);
    ...
    g.ya = function (a) {
        ...
        if (this.$().Ya("cvox_indicator_container"))return null;
        switch (a) {
            case 13:
            case 32:
                this.toggle()
